...
var import_dayjs = __toESM(require("dayjs")), computeChart = (input) => {
  let { timestamp, lat, lng } = input, timestr = timestamp.split("T")[1], [hours, minutes] = timestr.split(":"), date = (0, import_dayjs.default)(timestamp), hoursMinutes = parseInt(hours) + parseInt(minutes) / 60;
  ...
  let tjd = import_swisseph.default.swe_julday(date.get("year"), date.get("month"), date.get("day"), hoursMinutes, import_swisseph.default.SE_GREG_CAL);
  console.log(tjd);
