...
--
-- Name: notes notes_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: notes notes_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."notes"
    ADD CONSTRAINT "notes_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id");
...
--
-- Name: TABLE "notes"; Type: ACL; Schema: public; Owner: supabase_admin
--
